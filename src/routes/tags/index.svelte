...
<div class="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
  ...
  <p class="text-gray-600 dark:text-gray-400 mb-4">
    There are {tags.length} different tags to which the blogs belongs to. You can
    use the following tags to get the blogs/articles which belongs to them. These
    tags will help you find the articles easily if you know which tag they belongs
    to.
  </p>
