...
export const environment: ISveltekitStarterEnvironmentConfig<SVELTEKIT_STARTER_ENPOINT_CONFIG> = {
  ...
  spotifyConfig: {
    ...
    SPOTIFY_NOW_PLAYING_ENDPOINT: import.meta.env
      .SVELTEKIT_BLOG_SPOTIFY_NOW_PLAYING_ENDPOINT,
    SPOTIFY_TOP_TRACKS_ENDPOINT: import.meta.env
      .SVELTEKIT_BLOG_SPOTIFY_TOP_TRACKS_ENDPOINT,
    SPOTIFY_TOKEN_ENDPOINT: import.meta.env
      .SVELTEKIT_BLOG_SPOTIFY_TOKEN_ENDPOINT,
  },
  twitterConfig: {
    TWITTER_API_KEY: import.meta.env.SVELTEKIT_BLOG_TWITTER_API_KEY,
    TWITTER_TWEETS_ENDPOINT: import.meta.env
  ...
  gitHubConfig: {
    ...
    GITHUB_SNIPPETS_EDIT_URL: import.meta.env
      .SVELTEKIT_BLOG_GITHUB_SNIPPETS_EDIT_URL,
    ...
    GITHUB_USER_REPO_ENDPOINT: import.meta.env
      .SVELTEKIT_BLOG_GITHUB_USER_REPO_ENDPOINT,
  },
};
