...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-73b9c60a.js",
      css: [assets + "/_app/assets/start-464e9d0a.css", assets + "/_app/assets/vendor-863873a7.css"],
      js: [assets + "/_app/start-73b9c60a.js", assets + "/_app/chunks/vendor-b3989e7d.js"]
    },
    fetched: void 0,
    floc: false,
...
<div class="${"perspective-text svelte-s3775g"}"><div class="${"perspective-line svelte-s3775g"}"><p style="${"margin-left: 23px;transform:rotate(4deg)"}" class="${"text-black dark:text-white svelte-s3775g"}">LOOSE </p></div>
	<div class="${"perspective-line svelte-s3775g"}"><p style="${"margin-left: 56px;transform:rotate(-4deg)"}" class="${"text-black dark:text-white svelte-s3775g"}">LIPS</p></div>
	<div class="${"perspective-line svelte-s3775g"}"><p style="${"margin-left: 14px;"}" class="${"text-black dark:text-white svelte-s3775g"}">2.0</p></div></div>
...
<p class="${"font-bold text-2xl md:text-4xl tracking-tight mb-4 text-black dark:text-white svelte-s3775g"}" style="${"margin: auto;transform: rotate(-15deg);"}">HAVE A LOOKSY</p></div>
<div class="${"flex flex-row justify-left items-start max-w-5xl mx-auto"}"><div class="${"p-5"}">
	...
	<a href="${"events"}" class="${"viewAll svelte-s3775g"}"><p class="${"font-italic text-m text-white svelte-s3775g"}">View past events</p></a>
	</div>
